...
public abstract class Publicacion {
    ...
    // private final String tipo;      // "Libro" o "Revista". Se comenta porque publicacion se vuelve abstracta.
    ...
    public Publicacion(String titulo, String autor, int anio) { //Se modifico el constructor para eliminar tipo, paginas y numero.
